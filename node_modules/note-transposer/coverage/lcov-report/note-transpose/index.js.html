...
<html lang="en">
<head>
    <title>Code coverage report for note-transposer/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">note-transposer/</a> index.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var parse = require('array-notation/pitch/parse')
...
var transpose = operation(function (i, n) {
  ...
  var d = i.length === 2 &amp;&amp; n.length === 2 ? <span class="branch-0 cbranch-no" title="branch not covered" >null </span>: n[2] || i[2]
  return [n[0] + i[0], n[1] + i[1], d]
})
&nbsp;
<span class="missing-if-branch" title="else path not taken" >E</span>if (typeof module === 'object' &amp;&amp; module.exports) module.exports = transpose
<span class="missing-if-branch" title="if path not taken" >I</span>if (typeof window !== 'undefined') <span class="cstat-no" title="statement not covered" >window.transpose = transpose</span>
&nbsp;</pre></td></tr>
</table></pre>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sun Dec 20 2015 19:58:39 GMT+0100 (CET)
</div>
</div>
