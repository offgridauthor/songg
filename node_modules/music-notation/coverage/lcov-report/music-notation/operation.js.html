...
<html lang="en">
<head>
    <title>Code coverage report for music-notation/operation.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">music-notation/</a> operation.js
    </h1>
    <div class='clearfix'>
...
module.exports = function op (parse, str, fn) {
  ...
  return curry(function (a, b) {
    ...
    var v = fn(ac || <span class="branch-1 cbranch-no" title="branch not covered" >a,</span> bc || b)
    return str(v) || v
  }, fn.length)
}
&nbsp;</pre></td></tr>
